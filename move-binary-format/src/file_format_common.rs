...
const _: () = {
    ...
    assert!(BinaryFlavor::mask_and_shift_to_unflavor(x) == BinaryFlavor::BOS_FLAVOR);
};
...
impl BinaryFlavor {
    ...
    // The Bos flavor is 0x05
    pub const BOS_FLAVOR: u8 = 0x05;
    ...
    const fn shift_and_flavor(unflavored: u32) -> u32 {
        ((Self::BOS_FLAVOR as u32) << Self::SHIFT_AMOUNT) | unflavored
    }
}
