...
// Implicit aliases for Bos mode:
// use bos::object::{Self, ID, UID};
// use bos::transfer;
// use bos::tx_context::{Self, TxContext};
pub const IMPLICIT_BOS_MODULES: &[Symbol] = &[
    symbol!("object"),
    symbol!("transfer"),
    symbol!("tx_context"),
];
pub const IMPLICIT_BOS_MEMBERS: &[(Symbol, Symbol, ModuleMemberKind)] = &[
