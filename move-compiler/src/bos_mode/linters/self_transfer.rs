...
use crate::{
    ...
    parser::ast::Ability_,
    bos_mode::{BOS_ADDR_VALUE, TX_CONTEXT_MODULE_NAME},
};
...
const TRANSFER_FUNCTIONS: &[(AccountAddress, &str, &str)] = &[
    (BOS_ADDR_VALUE, TRANSFER_MOD_NAME, PUBLIC_TRANSFER_FUN),
...
impl SimpleAbsInt for SelfTransferVerifierAI {
    ...
    fn call_custom(
        ...
        if f.is(&BOS_ADDR_VALUE, TX_CONTEXT_MODULE_NAME, "sender") {
