...
//! This analysis flags situations when instances of a bos::table::Table or bos::table_vec::TableVec
//! or bos::bag::Bag are being compared for (in)equality at this type of comparison is not very
...
use crate::{
    ...
    parser::ast as P,
    bos_mode::{BOS_ADDR_NAME, BOS_ADDR_VALUE},
...
const COLLECTION_TYPES: &[(Symbol, AccountAddress, &str, &str)] = &[
    (BOS_ADDR_NAME, BOS_ADDR_VALUE, BAG_MOD_NAME, BAG_STRUCT_NAME),
    (
        BOS_ADDR_NAME,
        BOS_ADDR_VALUE,
        OBJECT_BAG_MOD_NAME,
