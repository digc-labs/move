...
pub const BOS_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x2);
pub const BOS_SYSTEM_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x3);
...
pub const BOS_ADDR_NAME: Symbol = symbol!("bos");
...
pub const BOS_MODULE_NAME: Symbol = symbol!("bos");
pub const BOS_OTW_NAME: Symbol = symbol!("BOS");

pub const BOS_SYSTEM_ADDR_NAME: Symbol = symbol!("bos_system");
pub const BOS_SYSTEM_MODULE_NAME: Symbol = symbol!("bos_system");
pub const BOS_SYSTEM_CREATE: Symbol = symbol!("create");
pub const CLOCK_MODULE_NAME: Symbol = symbol!("clock");
pub const CLOCK_TYPE_NAME: Symbol = symbol!("Clock");
pub const BOS_CLOCK_CREATE: Symbol = symbol!("create");
...
pub const BOS_DIAG_PREFIX: &str = "Bos ";
